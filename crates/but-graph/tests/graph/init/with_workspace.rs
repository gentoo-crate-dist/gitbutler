...
fn workspace_with_stack_and_local_target() -> anyhow::Result<()> {
    ...
    * fafd9d0 init
    ...
    ├── ≡:1:main <> origin/main →:5:⇡1⇣1 on fafd9d0
    │   └── :1:main <> origin/main →:5:⇡1⇣1
    │       ├── 🟣1f5c47b
    │       ├── ·0a415d8 (🏘️)
    │       └── ❄️73ba99d (🏘️)
    └── ≡:2:A on fafd9d0
...
fn tips_equivalent_to_workspace_metadata_are_order_independent() -> anyhow::Result<()> {
    ...
    // NOTE: `from_commit_traversal_tips` remains WALK-backed (explicit tips have no flip
    // counterpart yet), while `from_head`/`from_commit_traversal` build via the flip — the
...
fn proper_remote_ahead() -> anyhow::Result<()> {
    ...
    * fafd9d0 init
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    ⌂:1:main <> ✓refs/remotes/origin/main⇣2
    └── ≡:1:main <> origin/main →:2:⇣2 {1}
        └── :1:main <> origin/main →:2:⇣2
            ├── 🟣ca7baa7 (✓)
            └── 🟣7ea1468 (✓)
    ");
    Ok(())
...
fn target_with_remote_on_stack_tip() -> anyhow::Result<()> {
    ...
    * fafd9d0 (origin/main) init
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    📕🏘️:0:gitbutler/workspace[🌳] <> ✓refs/remotes/origin/main on fafd9d0
    └── ≡📙:3:main <> origin/main →:2: on fafd9d0 {1}
...
fn integrated_tips_stop_early_if_remote_is_not_configured() -> anyhow::Result<()> {
    ...
    * eb5f731 1
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    ⌂:2:A <> ✓refs/remotes/origin/main⇣3
    └── ≡:2:A on 4b3e5a8 {1}
        └── :2:A
    ");
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    ⌂:2:A <> ✓refs/remotes/origin/main⇣6
    └── ≡:2:A {1}
        └── :2:A
    ");
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    ⌂:1:DETACHED <> ✓refs/remotes/origin/main⇣3 on 79bbb29
    └── ≡:1:anon: on 4b3e5a8 {1}
        └── :1:anon:
            ├── ·d0df794 (✓)
            ├── ·09c6e08 (✓)
...
fn integrated_tips_do_not_stop_early() -> anyhow::Result<()> {
    ...
    * eb5f731 1
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    ⌂:6:main <> ✓refs/remotes/origin/main⇣3
    └── ≡:6:main <> origin/main →:7:⇣3 {1}
        └── :6:main <> origin/main →:7:⇣3
            ├── 🟣d0df794 (✓)
            ├── 🟣09c6e08 (✓)
            └── 🟣7b9f260 (✓)
    ");
...
-> anyhow::Result<()> {
    ...
    * fafd9d0 (origin/main, main, lane) init
    ...
    ├── 👉📕►►►:0[0]:gitbutler/workspace[🌳]
    │   └── ·f8f33a7 (⌂|🏘|001)
    │       └── ►:1[1]:advanced-lane <> origin/advanced-lane →:3:
    │           └── ·cbc6713 (⌂|🏘|101) ►dependent, ►on-top-of-dependent
    │               └── ►:2[2]:main <> origin/main →:4:
    │                   └── 🏁·fafd9d0 (⌂|🏘|✓|111) ►lane
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    📕🏘️:0:gitbutler/workspace[🌳] <> ✓refs/remotes/origin/main on fafd9d0
    └── ≡:1:advanced-lane <> origin/advanced-lane →:3: on fafd9d0
    ...
    * 2be54cd (main) outdated-main
    ...
    └── 👉📕►►►:2[0]:gitbutler/workspace[🌳]
        └── ►:0[1]:origin/main →:1:
            ...
            ├── ·988032f (⌂|🏘|✓|01)
            └── ·cd5b655 (⌂|🏘|✓|01)
                └── ►:1[2]:main <> origin/main →:0:
                    └── 🏁·2be54cd (⌂|🏘|✓|11)
    ");
    // Workspace is empty as everything is integrated.
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"📕🏘️⚠️:2:gitbutler/workspace[🌳] <> ✓refs/remotes/origin/main on 2cde30a");
...
fn partitions_with_long_and_short_connections_to_each_other() -> anyhow::Result<()> {
    ...
    * 3183e43 M1
    ...
    │               │           ├── ·bce0c5e (⌂|🏘|✓|1)
    │               │           └── 🏁·3183e43 (⌂|🏘|✓|1)
    │               └── ►:2[3]:long-main-to-workspace
    │                   ├── ·77f31a0 (⌂|🏘|✓)
    │                   ├── ·eb17e31 (⌂|🏘|✓)
    │                   ├── ·fe2046b (⌂|🏘|✓)
    │                   └── ·5532ef5 (⌂|🏘|✓)
    │                       └── 👉►:3[4]:main <> origin/main →:6:
    │                           └── ·2438292 (⌂|🏘|✓|1)
    │                               └── →:5:
    └── ►:6[0]:origin/main →:3:
        └── 🟣232ed06 (✓)
            ├── ►:8[1]:workspace-to-target
            │   ├── 🟣abcfd9a (✓)
            │   ├── 🟣bc86eba (✓)
            │   └── 🟣c7ae303 (✓)
            │       └── →:1: (workspace)
            └── ►:7[1]:long-workspace-to-target
                ├── 🟣9e2a79e (✓)
                ├── 🟣fdeaa43 (✓)
                ├── 🟣30565ee (✓)
                ├── 🟣0c1c23a (✓)
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    ⌂:3:main <> ✓refs/remotes/origin/main⇣11
    └── ≡:3:main <> origin/main →:6:⇣11 {1}
        └── :3:main <> origin/main →:6:⇣11
            ├── 🟣232ed06 (✓)
            ├── 🟣abcfd9a (✓)
            ├── 🟣bc86eba (✓)
            ├── 🟣c7ae303 (✓)
...
fn partitions_with_long_and_short_connections_to_each_other_part_2() -> anyhow::Result<()> {
    ...
    * 3183e43 (B, A) M1
    ...
    │               │       └── ►:5[6]:anon:
    │               │           └── 🏁·3183e43 (⌂|🏘|✓|1) ►A, ►B
    │               └── ►:2[4]:long-main-to-workspace
    │                   ├── ·b39c7ec (⌂|🏘|✓)
    │                   ├── ·2983a97 (⌂|🏘|✓)
    │                   ├── ·144ea85 (⌂|🏘|✓)
    │                   └── ·5aecfd2 (⌂|🏘|✓)
    │                       └── 👉►:4[5]:main <> origin/main →:6:
    │                           └── ·bce0c5e (⌂|🏘|✓|1)
    │                               └── →:5:
    └── ►:6[0]:origin/main →:4:
        ...
        └── 🟣fe06afd (✓)
            └── ►:7[1]:anon:
                └── 🟣3027746 (✓)
                    ...
                    │   └── 🟣f0d2a35 (✓)
                    │       └── →:1: (workspace)
                    └── ►:8[2]:longer-workspace-to-target
                        ├── 🟣edf041f (✓)
                        ├── 🟣d9f03f6 (✓)
                        ├── 🟣8d1d264 (✓)
                        ├── 🟣fa7ceae (✓)
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    ⌂:4:main <> ✓refs/remotes/origin/main⇣17
    └── ≡:4:main <> origin/main →:6:⇣17 {1}
        └── :4:main <> origin/main →:6:⇣17
            ├── 🟣024f837 (✓) ►long-workspace-to-target
            ├── 🟣64a8284 (✓)
            ├── 🟣b72938c (✓)
            ├── 🟣9ccbf6f (✓)
...
fn two_dependent_branches_with_embedded_remote() -> anyhow::Result<()> {
    ...
    * fafd9d0 (main) init
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    📕🏘️:0:gitbutler/workspace[🌳] <> ✓refs/remotes/origin/main on fafd9d0
    └── ≡📙:1:A <> origin/A →:5:⇡1⇣1 on fafd9d0 {1}
        ├── 📙:1:A <> origin/A →:5:⇡1⇣1
        │   ├── 🟣2b1808c
        │   ├── ·aadad9d (🏘️)
        │   └── ·96a2408 (🏘️|✓)
    ...
    └── ≡📙:1:A <> origin/A →:5:⇡1⇣1 on 96a2408 {1}
        └── 📙:1:A <> origin/A →:5:⇡1⇣1
            ├── 🟣2b1808c
            └── ·aadad9d (🏘️)
    ");
...
fn two_dependent_branches_rebased_with_remotes_merge_local() -> anyhow::Result<()> {
    ...
    * 281456a (main) init
    ...
    └── ≡📙:1:B <> origin/B →:4:⇡1⇣1 on 281456a {0}
        ├── 📙:1:B <> origin/B →:4:⇡1⇣1
        │   ├── 🟣e0bd0a7
        │   └── ·da597e8 (🏘️)
        └── 📙:2:A <> origin/A →:5:⇣1
    ...
    └── ≡📙:1:B <> origin/B →:4:⇡1⇣1 on 1818c17 {0}
        └── 📙:1:B <> origin/B →:4:⇡1⇣1
            ├── 🟣e0bd0a7
            └── ·da597e8 (🏘️)
    ");
...
fn two_dependent_branches_rebased_with_remotes_squash_merge_remote_ambiguous() -> anyhow::Result<()>
{
    ...
    * 281456a init
    ...
    └── ≡📙:1:D <> origin/D →:4:⇡1⇣1 on 0b6b861 {0}
        └── 📙:1:D <> origin/D →:4:⇡1⇣1
            ├── 🟣3045ea6
            └── ·624e118 (🏘️)
    ");
...
fn two_dependent_branches_rebased_with_remotes_squash_merge_remote() -> anyhow::Result<()> {
    ...
    * 281456a init
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    📕🏘️:0:gitbutler/workspace[🌳] <> ✓refs/remotes/origin/main on 0b6b861
    └── ≡📙:1:D <> origin/D →:4:⇡3⇣1 on 0b6b861 {0}
        └── 📙:1:D <> origin/D →:4:⇡3⇣1
            ├── 🟣bbd4ff6
            ├── ·353471f (🏘️)
            ├── ·8a4b945 (🏘️)
...
fn special_branch_do_not_allow_overly_long_segments() -> anyhow::Result<()> {
    ...
    * fafd9d0 init
    ...
    │                       └── ►:3[3]:main <> origin/main →:5:
    │                           └── ·971953d (⌂|🏘|101)
    │                               └── ►:4[4]:gitbutler/target <> origin/gitbutler/target →:6:
    │                                   ├── ·ce09734 (⌂|🏘|✓|111)
    │                                   └── 🏁·fafd9d0 (⌂|🏘|✓|111)
    ├── ►:5[0]:origin/main →:3:
    │   └── →:3: (main →:5:)
    └── ►:6[0]:origin/gitbutler/target →:4:
        └── →:4: (gitbutler/target →:6:)
    ");
...
fn shallow_boundary_below_workspace_lower_bound() -> anyhow::Result<()> {
    ...
    * bce0c5e (grafted) M2
    ...
    ├── ►:3[0]:origin/gitbutler/workspace →:0:
    │   └── 👉📕►►►:0[1]:gitbutler/workspace[🌳] <> origin/gitbutler/workspace →:3:
    │       └── ·00e1860 (⌂|🏘|001)
    │           └── 📙►:1[2]:A <> origin/A →:4:
    │               └── ·6507810 (⌂|🏘|101)
    │                   └── ►:2[3]:main <> origin/main →:5:
...
fn shallow_boundary_in_workspace_prevents_lower_bound() -> anyhow::Result<()> {
    ...
    └── ►:2[0]:origin/gitbutler/workspace →:0:
        └── 👉📕►►►:0[1]:gitbutler/workspace[🌳] <> origin/gitbutler/workspace →:2:
            └── ·00e1860 (⌂|🏘|1)
                └── 📙►:1[2]:A
                    └── ⛰·6507810 (⌂|🏘|⛰|1)
    ");
...
fn remote_and_integrated_tracking_branch_on_merge_extra_target() -> anyhow::Result<()> {
    ...
    * 3183e43 M1
    ...
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), @"
    📕🏘️:0:gitbutler/workspace[🌳] <> ✓refs/remotes/origin/main⇣1 on 1ee1e34
    └── ≡📙:1:A <> origin/A →:7:⇡1⇣1 on 1ee1e34 {1}
        └── 📙:1:A <> origin/A →:7:⇡1⇣1
            ├── 🟣2181501
            └── ·9f47a25 (🏘️)
    ");
...
fn remote_trailing_local_stack() -> anyhow::Result<()> {
    ...
    * fafd9d0 (origin/main, main) init
    ...
    │           └── 🏁·ce3278a (⌂|🏘|01)
    └── ►:3[0]:origin/main →:2:
        └── ►:2[1]:main <> origin/main →:3:
            └── 🏁·fafd9d0 (⌂|✓|10)
    ");
    insta::assert_snapshot!(graph_workspace(&graph.into_workspace()?), "this is a weird state as the target is actually disjoint from the workspace - it appears empty now", @"📕🏘️:0:gitbutler/workspace[🌳] <> ✓refs/remotes/origin/main on cb7021b");
    Ok(())
}
